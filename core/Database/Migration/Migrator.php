...
class Migrator
{
	public static function migrate(): void
	{
		...
		{
			self::deleteData();
			$mSQL = file_get_contents(ROOT . '/src/Migration/2025.02.21_21.17_migration_initiation.sql');

			$DBOperator->query($mSQL);
			$DBOperator->query("INSERT INTO migration (name) VALUES ('2025.02.21_21.17_migration_initiation.sql')");
		}
